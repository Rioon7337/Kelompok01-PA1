...
<style>
    ...
    .hero-fas .container { position: relative; z-index: 2; }
    .hero-badge {
    ...
    .hero-fas h1 span { color: var(--gold-light); }
    .hero-fas p { color: rgba(255,255,255,0.75); font-size: 0.9rem; }
    .hero-divider { width: 50px; height: 3px; background: var(--gold); margin: 18px auto; border-radius: 4px; }

    .fas-section { padding: 70px 0 90px; }
    ...
    .fas-card:hover { transform: translateY(-8px); box-shadow: var(--shadow-xl); border-color: rgba(198,164,59,0.15); }
    ...
    .fas-card:hover .card-img-wrapper img { transform: scale(1.06); }
    .card-img-overlay {
    ...
    .fas-card:hover .card-img-overlay { opacity: 1; }
    .fas-card:hover .card-img-overlay i { transform: scale(1); }
    .card-badge {
    ...
    @media (max-width: 992px) { .hero-fas h1 { font-size: 2.2rem; } }
    @media (max-width: 768px) { .hero-fas { padding: 110px 0 60px; } .hero-fas h1 { font-size: 1.8rem; } .fas-section { padding: 50px 0 70px; } }
    @media (max-width: 576px) { .hero-fas h1 { font-size: 1.5rem; } .card-content { padding: 18px; } }
</style>
